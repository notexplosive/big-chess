...
internal class TurnAnnouncement : AnimatedObject
{
    ...
    private TweenableFloat _textScale = new(1);
    private TweenableFloat _barScale = new(1);
    private TweenableFloat _opacity = new(0);
    ...
    public override void DrawScaled(Painter painter)
    {
        ...
        painter.DrawStringWithinRectangle(Client.Assets.GetFont("engine/logo-font", (int) (120 * _textScale)), $"{_color} to move", barRectangle, Alignment.Center, new DrawSettings{Color = textColor, Depth = Depth.Middle - 100});
    }
